package dev.zonely.whiteeffect.nms.v1_8_R3;
...
import dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntityItem;
import dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntityNPCPlayer;
import dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntityStand;
import dev.zonely.whiteeffect.nms.v1_8_R3.entity.HumanController;
import dev.zonely.whiteeffect.nms.v1_8_R3.utils.PlayerlistTrackerEntry;
import dev.zonely.whiteeffect.nms.v1_8_R3.utils.UUIDMetadataStore;
...
public class NMS1_8R3 implements INMS {
   ...
   public NMS1_8R3() {
      ...
      CLASS_TO_NAME.get(null).put(EntityStand.class, "ZonelyCore-EntityStand");
      CLASS_TO_ID.get(null).put(dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntityArmorStand.class, 30);
      CLASS_TO_NAME.get(null).put(dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntityArmorStand.class, "ZonelyCore-ArmorStand");
      CLASS_TO_ID.get(null).put(dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntitySlime.class, 55);
      CLASS_TO_NAME.get(null).put(dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntitySlime.class, "ZonelyCore-Slime");
      CLASS_TO_ID.get(null).put(dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntityItem.class, 1);
      CLASS_TO_NAME.get(null).put(dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntityItem.class, "ZonelyCore-Item");
   ...
   public IArmorStand createArmorStand(Location location, String name, HologramLine line) {
      IArmorStand armor = line == null ? new EntityStand(location) : new dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntityArmorStand(((CraftWorld) location.getWorld()).getHandle(), line);
   ...
   public IItem createItem(Location location, ItemStack item, HologramLine line) {
      dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntityItem eitem = new dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntityItem(((CraftWorld) location.getWorld()).getHandle(), line);
   ...
   public ISlime createSlime(Location location, HologramLine line) {
      dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntitySlime slime = new dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntitySlime(((CraftWorld) location.getWorld()).getHandle(), line);
   ...
   public Hologram getHologram(Entity entity) {
      ...
      HologramLine e = null;
      if (en instanceof dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntityArmorStand) {
         e = ((dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntityArmorStand) en).getLine();
      } else if (en instanceof dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntitySlime) {
         e = ((dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntitySlime) en).getLine();
      } else if (en instanceof dev.zonely.whiteeffect.nms.v1_8_R3.entity.EntityItem) {
