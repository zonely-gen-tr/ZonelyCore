...
public final class CenteredMessage {
      ...
      if (message != null && !message.equals("")) {
         ...
         for(spaceLength = 0; spaceLength < toCompensate; ++spaceLength) {
            ...
            if (c == 167) {
               ...
               CenteredMessage.DefaultFontSize dFI = CenteredMessage.DefaultFontSize.getDefaultFontSize(c);
         ...
         spaceLength = CenteredMessage.DefaultFontSize.SPACE.getLength() + 1;
         int compensated = 0;
   ...
   private static enum DefaultFontSize {
      A('A', 5),
      a('a', 5),
      B('B', 5),
      b('b', 5),
      ...
      private DefaultFontSize(char character, int length) {
         this.character = character;
         this.length = length;
      }

      public static CenteredMessage.DefaultFontSize getDefaultFontSize(char c) {
         CenteredMessage.DefaultFontSize[] var1 = values();
         int var2 = var1.length;

         for(int var3 = 0; var3 < var2; ++var3) {
            CenteredMessage.DefaultFontSize dFI = var1[var3];
